        ...
        <Row>
          ...
          <Col>
            ...
            <Form.Group as={Row} controlId="formBank">
              <Form.Label column sm={4}>은행</Form.Label>
              <Col sm={8}>
                <Form.Control
                  type="text"
                  name="bank"
            ...
            <Form.Group as={Row} controlId="formAccountHolder">
              <Form.Label column sm={4}>계좌명</Form.Label>
              <Col sm={8}>
                <Form.Control
                  type="text"
                  name="accountHolder"
            ...
            <Form.Group as={Row} controlId="formAccountNumber">
              <Form.Label column sm={4}>계좌번호</Form.Label>
              <Col sm={8}>
                <Form.Control
                  type="text"
                  name="accountNumber"
            ...
            <Form.Group as={Row} controlId="formMemo">
              <Form.Label column sm={4}>메모</Form.Label>
              <Col sm={8}>
                <Form.Control
                  as="textarea"
                  rows={3}
            ...
            {[...Array(6).keys()].map(i => (
              <div key={`family${i + 1}`}>
                <Form.Group as={Row} controlId={`formFamilyName${i + 1}`}>
                  <Form.Label column sm={4}>가족 이름 {i + 1}</Form.Label>
                  <Col sm={8}>
                    <Form.Control
                      type="text"
                      name={`familyName${i + 1}`}
                ...
                <Form.Group as={Row} controlId={`formRelationship${i + 1}`}>
                  <Form.Label column sm={4}>가족 관계 {i + 1}</Form.Label>
                  <Col sm={8}>
                    <Form.Control
                      type="text"
                ...
                <Form.Group as={Row} controlId={`formFamilyBirthdate${i + 1}`}>
                  <Form.Label column sm={4}>가족 생년월일 {i + 1}</Form.Label>
                  <Col sm={8}>
                    <Form.Control
                      type="date"
                ...
                <Form.Group as={Row} controlId={`formFamilyGender${i + 1}`}>
                  <Form.Label column sm={4}>가족 성별 {i + 1}</Form.Label>
                  <Col sm={8}>
                    <Form.Control
                      as="select"
                      name={`gender${i + 1}`}
