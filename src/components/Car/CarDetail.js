      ...
      <Container>
        <Row>
          ...
          <Form.Group as={Row} controlId="formUninsuredMotorist">
              <Form.Label column sm={5}>보험 미가입 차량</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formOwnDamage">
              <Form.Label column sm={5}>자기 손해</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
                  name="ownDamage"
            ...
            <Form.Group as={Row} controlId="formEmergencyDispatch">
              <Form.Label column sm={5}>긴급 출동</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formSubscriptionExperience">
              <Form.Label column sm={5}>가입 경험</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formLegalViolations">
              <Form.Label column sm={5}>법적 위반</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formDiscountSurcharge">
              <Form.Label column sm={5}>할인/할증</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formSpecialSurcharge1">
              <Form.Label column sm={5}>특별 할증 1</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formSpecialSurcharge2">
              <Form.Label column sm={5}>특별 할증 2</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formThreeYearAccidentRate">
              <Form.Label column sm={5}>3년 사고율</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formOneYearAccidentScore">
              <Form.Label column sm={5}>1년 사고 점수</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formThreeYearAccidentScore">
              <Form.Label column sm={5}>3년 사고 점수</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formCarSubscriptionExperience">
              <Form.Label column sm={5}>자동차 가입 경험</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formOtherOwnedCars">
              <Form.Label column sm={5}>다른 소유 차량</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
                  name="otherOwnedCars"
            ...
            <Form.Group as={Row} controlId="formCurrentMileage">
              <Form.Label column sm={5}>현재 주행거리</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
                  name="currentMileage"
            ...
            <Form.Group as={Row} controlId="formAnnualMileage">
              <Form.Label column sm={5}>연간 주행거리</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
                  name="annualMileage"
            ...
            <Form.Group as={Row} controlId="formMileageDiscount">
              <Form.Label column sm={5}>주행거리 할인</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
            ...
            <Form.Group as={Row} controlId="formCustomerConsultation">
              <Form.Label column sm={5}>고객 상담(메모)</Form.Label>
              <Col sm={7}>
                <Form.Control
                  as="textarea"
                  rows={3}
            ...
            <Form.Group as={Row} controlId="formPreConsent">
              <Form.Label column sm={5}>사전 동의</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
                  name="preConsent"
            ...
            <Form.Group as={Row} controlId="formConsentDate">
              <Form.Label column sm={5}>동의 날짜</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="date"
                  name="consentDate"
            ...
            <Form.Group as={Row} controlId="formPreConsentNumber">
              <Form.Label column sm={5}>사전 동의 번호</Form.Label>
              <Col sm={7}>
                <Form.Control
                  type="text"
